...
struct PostService {
    ...
    static func fetchPosts(forUser uid: String, completion: @escaping([Post]) -> Void) {
        ...
        query.getDocuments { snapshot, error in
            ...
            posts = posts.sorted(by: { $0.timestamp.seconds > $1.timestamp.seconds })
            completion(posts)
        }
    }
    ...
    static func likePost(post: Post, completion: @escaping(FirestoreComletion)) {
    ...
    static func unlikePost(post: Post, completion: @escaping(FirestoreComletion)) {
